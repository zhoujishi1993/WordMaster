...
public abstract class ResultPanel extends VBox {
	...
	private void createChart() {
		ObservableList<PieChart.Data> pieChartData1 =
                ...
                new PieChart.Data("正确", result.getCorrect()/result.getRecited()*100),
                new PieChart.Data("错误", result.getWrong()/result.getRecited()*100));
        ...
        ObservableList<PieChart.Data> pieChartData2 =
                FXCollections.observableArrayList(
                new PieChart.Data("背诵", result.getRecited()/result.getTotalNum()*100),
                new PieChart.Data("未背诵", (1-result.getRecited()/result.getTotalNum())*100));
